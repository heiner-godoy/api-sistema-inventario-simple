...
class ProductoUpdate(BaseModel):
    categoria_id: int = Field(None, description="ID de la categoría")
    nombre: str = Field(None, min_length=2, max_length=100, description="Nombre del producto")
    descripcion: Optional[str] = Field(None, description="Descripción del producto")
    precio: float = Field(None, gt=0, description="Precio del producto")
    stock: int = Field(None, ge=0, description="Stock inicial del producto")
